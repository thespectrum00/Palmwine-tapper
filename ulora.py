...
#        gpio_interrupt = Pin(self._interrupt, Pin.IN, Pin.PULL_DOWN)
        ...
        #mode_value = self._spi_read(REG_01_OP_MODE)
        #print(f"Read Mode: {mode_value:#x}")  # Print the value in hex
        #assert mode_value == (MODE_SLEEP | LONG_RANGE_MODE), "LoRa initialization failed"
